"""
Django settings for django_jwt_ project.
...
SECRET_KEY = 'django-insecure--uwtyof^-u(+qevil%-w)&9i!*93&%=2n^*aeglej-c999_wh0'
...
WSGI_APPLICATION = 'django_jwt_.wsgi.application'
